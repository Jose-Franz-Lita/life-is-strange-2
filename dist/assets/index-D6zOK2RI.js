...
//#endregion
//#region assets/index-DUN9JjyB.js
(function() {
		...
		children: [
			...
			(0, f.jsxs)(`section`, {
				...
				children: [(0, f.jsxs)(`div`, {
					...
					}), (0, f.jsx)(`div`, { className: `hero-overlay` })]
				}), (0, f.jsxs)(`div`, {
					className: `hero-content`,
					children: [
						(0, f.jsx)(`h1`, { children: `Life is Strange 2` }),
						(0, f.jsx)(`p`, { children: `A Journey of Brotherhood, Survival, and Choice` }),
						(0, f.jsx)(`p`, {
							className: `hero-subtitle`,
							children: `Every choice matters. Every moment counts.`
						})
					]
				})]
			}),
			(0, f.jsx)(`section`, {
				...
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`h2`, { children: `Welcome to the Road` }),
						(0, f.jsx)(`div`, {
							className: `logo-section`,
							children: (0, f.jsx)(`img`, {
								src: `./lis2-logo.png`,
								alt: `Life is Strange 2 Logo`,
								className: `section-logo`
							})
						}),
						(0, f.jsx)(`p`, {
							className: `section-intro`,
							children: `Life is Strange 2 follows brothers Sean and Daniel Diaz as they flee across America after a tragic incident. With Daniel possessing mysterious telekinetic powers, the brothers must navigate a dangerous world while making choices that will determine their fate and the fate of those they meet along the way.`
						}),
						(0, f.jsxs)(`div`, {
							...
							children: [
								(0, f.jsxs)(`div`, {
									...
									children: [
										...
										(0, f.jsx)(`h3`, { children: `Brotherhood` }),
										(0, f.jsx)(`p`, { children: `The core of the story is the bond between Sean and Daniel. Every decision Sean makes affects Daniel's development and their relationship.` })
									]
								}),
								(0, f.jsxs)(`div`, {
									className: `overview-card`,
									children: [
										...
										(0, f.jsx)(`h3`, { children: `Telekinetic Powers` }),
										(0, f.jsx)(`p`, { children: `Daniel possesses extraordinary telekinetic abilities that grow stronger throughout the game. Sean must help Daniel learn to control them.` })
									]
								}),
								(0, f.jsxs)(`div`, {
									className: `overview-card`,
									children: [
										...
										(0, f.jsx)(`h3`, { children: `Cross-Country Journey` }),
										(0, f.jsx)(`p`, { children: `Travel across America from Seattle to Mexico, meeting diverse characters and facing moral dilemmas at every turn.` })
									]
								}),
								(0, f.jsxs)(`div`, {
									className: `overview-card`,
									children: [
										...
										(0, f.jsx)(`h3`, { children: `Moral Choices` }),
										(0, f.jsx)(`p`, { children: `Your decisions shape not only the brothers' journey but also influence the people they encounter and the world around them.` })
									]
								})
							]
						})
			...
			(0, f.jsx)(`section`, {
				...
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`h2`, { children: `The Story` }),
						(0, f.jsx)(`p`, {
							className: `section-intro`,
							children: `A tale of survival, brotherhood, and impossible choices`
						}),
						(0, f.jsxs)(`div`, {
							...
							children: [
								(0, f.jsxs)(`div`, {
									...
									children: [(0, f.jsx)(`h3`, { children: `The Incident` }), (0, f.jsx)(`p`, { children: `Life is Strange 2 begins in Seattle with a tragic incident that forces brothers Sean and Daniel Diaz to flee their home. What starts as a desperate escape becomes a cross-country journey filled with danger, mystery, and moral complexity. The brothers must survive on their own, relying on each other as their only family.` })]
								}),
								(0, f.jsxs)(`div`, {
									className: `story-card`,
									children: [(0, f.jsx)(`h3`, { children: `The Power` }), (0, f.jsx)(`p`, { children: `As the brothers flee, Daniel's extraordinary ability manifests: telekinesis. This power becomes both a blessing and a curse, offering protection but also drawing unwanted attention. Sean must guide Daniel in learning to control these abilities while keeping him safe from those who would exploit him.` })]
								}),
								(0, f.jsxs)(`div`, {
									className: `story-card`,
									children: [(0, f.jsx)(`h3`, { children: `The Journey` }), (0, f.jsx)(`p`, { children: `From the forests of Oregon to the deserts of Arizona, the brothers travel south toward Mexico, hoping to find safety and a new life. Along the way, they meet diverse characters—some helpful, some dangerous—and face situations that test their morality and bond.` })]
								}),
								(0, f.jsxs)(`div`, {
									className: `story-card`,
									children: [(0, f.jsx)(`h3`, { children: `The Choices` }), (0, f.jsx)(`p`, { children: `Every decision Sean makes has consequences that ripple throughout the story. Whether to trust strangers, how to use Daniel's powers, and what values to instill in his brother—these choices determine not only their fate but the fate of everyone they encounter.` })]
								})
							]
						})
					]
			...
			(0, f.jsx)(`section`, {
				...
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`h2`, { children: `Main Characters` }),
						(0, f.jsx)(`p`, {
							className: `section-intro`,
							children: `Meet the unforgettable characters of Life is Strange 2`
						}),
						(0, f.jsx)(`div`, {
			...
			(0, f.jsx)(`section`, {
				id: `episodes`,
				className: `section episodes-section`,
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`h2`, { children: `Episodes` }),
						(0, f.jsx)(`p`, {
							className: `section-intro`,
							children: `Explore all 5 episodes of Life is Strange 2`
						}),
						(0, f.jsx)(`div`, {
							...
							children: [
								...
								children: [(0, f.jsxs)(`div`, {
									...
									children: [(0, f.jsx)(`div`, {
										className: `episode-number-circle`,
									...
									children: (0, f.jsx)(`p`, { children: e.description })
								})]
							}, e.number))
						})
					]
			...
			(0, f.jsx)(`section`, {
				id: `endings`,
				className: `section endings-section`,
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`h2`, { children: `All Endings` }),
						(0, f.jsx)(`p`, {
							className: `section-intro`,
							children: `Discover the different paths and endings of Life is Strange 2`
						}),
						(0, f.jsx)(`div`, {
							className: `endings-grid`,
							children: [
								{
			...
			(0, f.jsx)(`footer`, {
				...
				children: (0, f.jsxs)(`div`, {
					className: `container`,
					children: [
						(0, f.jsx)(`p`, { children: `© 2024 Project Only` }),
						(0, f.jsx)(`p`, { children: `Life is Strange 2 is a trademark of Square Enix and Dontnod Entertainment.` }),
						(0, f.jsxs)(`div`, {
...
(0, u.createRoot)(document.getElementById(`root`)).render((0, f.jsx)(l.StrictMode, { children: (0, f.jsx)(p, {}) }));
//#endregion
