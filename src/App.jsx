    ...
    <div className="app">
      ...
      <nav className="navbar">
        <div className="nav-container">
          <div className="nav-logo">
            <img src="./dist/lis2-nav-logo.png" alt="Life is Strange 2" className="logo-img" />
          </div>
      ...
      <section className="hero">
        <div className="hero-image-container">
          <img src="./dist/lis2-hero.jpg" alt="Life is Strange 2" className="hero-image" />
      ...
      <section id="overview" className="section overview-section">
        <div className="container">
          ...
          <div className="logo-section">
            <img src="./dist/lis2-logo.png" alt="Life is Strange 2 Logo" className="section-logo" />
          </div>
